...
<body class="" style="background-color: #2a2822">
    ...
    <div class="container" style="background-color: #2a2822">
        <br><br><br>
        <div class="text-center text-light"><p>Manage Gundam List</p></div>      
        <div class="card" style="background-color: #38362e">
            <div class="card-body">
                <div class="container">
                    <div class="row py-5">
                        <div class="col"><div class="text-light"><h2>Gundam List Table</h2></div></div>
                        <div class="col"><a href="/admin/create" class="btn btn-primary float-end">Create</a></div>
                    </div>
                    <div class="mb-5 px-4">
                        <div class="table">
                                ...
                                <tbody>
                                    @foreach ($gundam as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->desc }}</td>
                                            <td>{{ $item->img }}</td>
                                            <form action="/admin/gundam/{{ $item->id }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                @method('delete')
                                                @csrf
                                                <td>
